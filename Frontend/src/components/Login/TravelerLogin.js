                ...
                <div className="login-form">
                    ...
                    <p class="panel-title">Account login</p>
                            ...
                            <div className="form-group">
                                <input onChange = {this.emailidChangeHandler} type="text" className="form-control1" name="emailid" placeholder="Email address"/>
                            </div>
                            <div className="form-group">
                                <input onChange = {this.passwordChangeHandler} type="password" className="form-control1" name="password" placeholder="Password"/>
                            </div>
                            <div>
